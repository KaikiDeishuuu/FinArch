...
type TransactionRepository interface {
	...
	ListUnreimbursedPersonalExpenses(ctx context.Context, userID string, projectID *string, maxN int) ([]model.Transaction, error)
	...
	SumPoolBalance(ctx context.Context, userID string) (model.Money, model.Money, error)
}
