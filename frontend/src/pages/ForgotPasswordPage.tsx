      ...
      <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl shadow-violet-900/20 p-8 w-full max-w-md">
        ...
        {sent ? (
          <div className="text-center">
            ...
            <Link to="/login" className="text-sm text-violet-600 hover:underline">返回登录</Link>
          </div>
        ) : (
          <>
            ...
            <div className="text-center mt-4">
              <Link to="/login" className="text-xs text-gray-400 hover:text-violet-600 transition-colors">
                返回登录
              </Link>
            </div>
          </>
