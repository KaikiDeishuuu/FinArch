    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100">
        <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md text-center">
          ...
          <Link to="/forgot-password" className="text-sm text-blue-600 hover:underline">重新申请</Link>
        </div>
      </div>
    )
  }
      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
        ...
        {success ? (
          <div className="text-center">
            ...
            <Link to="/login" className="bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium px-6 py-2 rounded-lg transition-colors">
              前往登录
            </Link>
          </div>
        ) : (
