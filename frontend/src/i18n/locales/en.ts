const en = {
  translation: {
    ...
    nav: {
      ...
      moreDescription: 'Budgets, recurring rules, exchange rates, and preferences live here.',
      preferences: 'Preferences',
      account: 'Account',
      moreHints: {
        '/budgets': 'Track spending goals',
        '/recurring': 'Manage scheduled flows',
        '/exchange': 'Convert currencies fast',
    ...
    dashboard: {
      ...
      recurringCard: {
        ...
        subtitle: 'Automatically generate rent, salary, subscriptions, and fixed entries.',
        desc: 'Create rules with timezone-aware schedules; due entries are generated idempotently by the backend scheduler.',
        action: 'Manage Recurring',
        next: 'Next: {{name}} · {{time}}',
        emptyTitle: 'No recurring rules yet',
        emptyDesc: 'Add a rule to preview upcoming occurrences and let FinArch generate due transactions.',
    ...
    recurring: {
      title: 'Recurring Transactions',
      subtitle: 'Automate fixed income and expense entries with idempotent schedules.',
      listTitle: 'Rules',
      history: 'History',
      noHistory: 'No generated occurrences yet',
      generateNow: 'Generate now',
      pause: 'Pause',
      resume: 'Resume',
      confirmDelete: 'Delete recurring rule "{{name}}"?',
      nextDue: 'Next due: {{name}} · {{time}}',
      noNextDue: 'No active upcoming rule',
      everyInterval: 'Every {{interval}} {{frequency}}',
      previewTitle: 'Upcoming preview',
      previewEmpty: 'Fill in amount, account, and date to preview occurrences.',
      summary: {
        active: 'Active rules',
      ...
      form: {
        ...
        editTitle: 'Edit Rule',
        subtitle: 'Generated transactions stay normal records and will not mutate past entries after edits.',
        name: 'Rule name',
        namePlaceholder: 'e.g. Monthly rent, salary, subscription',
        frequency: 'Frequency',
        interval: 'Interval',
        ...
        monthEndPolicy: 'Month-end policy',
        catchUp: 'Generate missed occurrences after downtime',
      },
      frequency: {
        daily: 'day',
        weekly: 'week',
      ...
      monthEndPolicy: {
        clamp: 'Clamp to month end',
        skip: 'Skip missing dates',
      },
      status: {
        active: 'Active',
        paused: 'Paused',
      ...
      empty: {
        ...
        desc: 'Create a rule for rent, payroll, subscriptions, or other fixed transactions.',
      },
      errors: {
      ...
      toast: {
        ...
        paused: 'Rule paused',
        resumed: 'Rule resumed',
        generated: '{{count}} transaction(s) generated',
        failed: 'Recurring operation failed. Please try again.',
      },
    },
    ...
    attachments: {
      ...
      choose: 'Choose file',
      upload: 'Upload',
      runOcr: 'Run OCR after upload',
      addHint: 'Upload a receipt or invoice, optionally extract suggestions with OCR, then confirm before saving.',
      pendingLink: 'Will link after saving: {{name}}',
      ...
      ocr: {
        ...
        unavailable: 'OCR provider unavailable',
        failed: 'OCR failed',
    ...
    settings: {
      ...
      restore: {
        ...
        desc: 'Upload a .db or .zip backup file to restore data. The system will automatically keep a safety snapshot of current data.',
    ...
    disasterRestore: {
      ...
      step1: {
        ...
        dropHint: 'Click to select or drag & drop a .db or .zip file',
        maxSize: 'Max 100 MB',
