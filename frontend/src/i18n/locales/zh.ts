const zh = {
  translation: {
    ...
    nav: {
      ...
      more: '更多',
      moreTitle: '更多功能',
      moreDescription: '预算、周期交易、汇率与偏好设置都收纳在这里。',
      preferences: '偏好设置',
      account: '账户',
      moreHints: {
        '/budgets': '管理预算进度',
    ...
    dashboard: {
      ...
      recurringCard: {
        title: '周期交易',
        subtitle: '自动生成房租、工资、订阅等固定收支。',
        desc: '创建带时区的周期规则；后端调度器会以幂等方式生成到期交易。',
        action: '管理周期交易',
        next: '下一笔：{{name}} · {{time}}',
        emptyTitle: '暂无周期规则',
        emptyDesc: '添加规则后可预览未来执行时间，并让 FinArch 自动生成到期交易。',
    ...
    recurring: {
      ...
      pause: '暂停',
      resume: '启用',
      confirmDelete: '确认删除周期规则「{{name}}」？',
      nextDue: '下一笔：{{name}} · {{time}}',
      noNextDue: '暂无启用中的待执行规则',
      everyInterval: '每 {{interval}} {{frequency}}',
      previewTitle: '未来执行预览',
      previewEmpty: '填写金额、账户和日期后可预览执行时间。',
      summary: {
        active: '启用规则',
        failed: '需关注',
      },
      form: {
        createTitle: '新建规则',
        editTitle: '编辑规则',
        subtitle: '生成后的交易仍是普通记录；修改规则不会回写历史交易。',
        name: '规则名称',
        namePlaceholder: '如：每月房租、工资、订阅费',
        frequency: '频率',
        interval: '间隔',
        startDate: '开始日期',
        endDate: '结束日期',
    ...
    attachments: {
      ...
      upload: '上传',
      runOcr: '上传后执行 OCR',
      addHint: '上传收据或发票，可选择 OCR 提取建议；保存前需手动确认。',
      pendingLink: '保存后将关联：{{name}}',
      empty: '暂无附件',
      toast: {
        uploaded: '附件已上传',
        deleted: '附件已删除',
    ...
    settings: {
      ...
      restore: {
        ...
        confirmButton: '确认恢复',
        desc: '上传 .db 或 .zip 备份文件恢复数据。系统会自动保留当前数据的安全快照。',
        warning: '将<strong>覆盖当前数据</strong>恢复为此备份。恢复前系统会自动保存安全快照。',
        restoring: '恢复中...',
        restoreNow: '立即恢复数据',
        crossAccount: {
          title: '跨账号恢复验证',
          desc: '检测到该备份来自其他账号，恢复前请完成邮箱验证码验证。',
          prompt: '检测到跨账号备份，需进行邮箱验证。',
          originalEmail: '原账号邮箱',
          verificationCode: '验证码',
          sendCode: '发送验证码',
          verify: '验证身份',
          requiredEmail: '请输入原账号邮箱',
          requiredCode: '请输入验证码',
          emailSent: '验证码已发送至 {{email}}',
          emailSentToast: '验证码邮件已发送',
          verified: '验证成功，正在恢复备份...',
          failed: '验证失败，请重试',
        },
        toast: {
